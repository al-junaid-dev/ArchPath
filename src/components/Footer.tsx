        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              {/* GitHub SVG */}
              <a href="https://github.com/al-junaid-dev/PathFinder" className="text-zinc-400 hover:text-zinc-900 transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-zinc-500">
              <li><Link href="/generator" className="hover:text-zinc-900 transition-colors">AI Generator</Link></li>
              <li><Link href="/dashboard" className="hover:text-zinc-900 transition-colors">Student Profile</Link></li>
            </ul>
          </div>
