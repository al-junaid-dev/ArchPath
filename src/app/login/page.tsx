  ...
  return (
    <div className="w-full max-w-md p-8 space-y-8 bg-white border border-zinc-200 rounded-2xl shadow-sm">
      ...
      <Button 
        ...
        className="w-full h-11 text-base font-medium shadow-sm transition-all border-zinc-200 hover:bg-zinc-50 text-zinc-800"
      >
        {googleLoading ? (
      ...
      <div className="relative flex items-center py-2">
        ...
        <span className="flex-shrink-0 mx-4 text-zinc-400 text-sm">or continue with email</span>
        <div className="flex-grow border-t border-zinc-200"></div>
      </div>
